// ─────────────────────────────────────────────────────────────────────────────
// @repo/types · SHARED CONTRACT  (lives at packages/types/index.ts)
...
// Enums MUST stay identical to contracts/schema.prisma.
// ─────────────────────────────────────────────────────────────────────────────
import { z } from "zod";
...
export type ProblemDTO = {
  ...
  category: Category; status: ProblemStatus; severity: z.infer<typeof Severity>;
...
// ── AI SERVICE SHAPES (mirror apps/ai Pydantic + doc 04) ─────────────────────
